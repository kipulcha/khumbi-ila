...
<head>
    <meta charset="UTF-8">
    <title>Tailor Made Packages - Khumbila Adventure Travel</title>
    <!-- favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="./img/icon.png">
    <meta name="description"
          content="Want a Custom Package? Contact us and We'll make one that suits you the Best.">
    <meta name="author" content="Rajen Kaji Shrestha">
    <meta name="robots" content="index,follow"/>
    <meta property="og:title" content="Tailor Made Packages - Khumbila Adventure Travel"/>
            ...
            <div class="col-xs-5 col-sm-5 col-md-10">
                <div class="nav-header">
                    <ul class="navigation list-inline">
                        ...
                        <li class="active"><a href="./tailor-made.php">Tailor Made</a></li>
                        <li class="dropdown">
    ...
    if ($_POST['name'] || $_POST['email'] != "") {
        ...
        if (@$insert) {
            ...
            if (mail($to, $mail_title, $message1, $headers)) {
                $mydb->redirect("tailor-made?msg=sent");

            } else {
                $mydb->redirect("./tailor-made?msg=fail");
        ...
        $mydb->redirect("./tailor-made?msg=error");
...
<!-- Page Header >
<section class="inner-banner" style="padding-bottom: 20px;">
    <div class="container text-center">
        <h2><span>Tailor Made</span></h2>
    </div>
</section>
<!-- /Page Header --->

<!-- Page Body --->
<section class="contact-page contact-page-two blog-2-col blog-3-col section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <?php echo $mydb->select_field("short_content", "tbl_about", "id='5'"); ?>
