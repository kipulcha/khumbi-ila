...
Class PDOModel {
    ...
    /**
     * Rajen Added
     * Select Specefic field data from the db as String
     * */
    public function select_field($field_names, $table_name, $where_clause=""){
        if($where_clause==""){
     ...
     *  Returns pagination
     */
    public function pagination($page = 1, $totalrecords = 0, $limit = 10, $adjacents = 1) {
        $pagination = "";
        if ($totalrecords > 0) {
            if (!$limit)
                $limit = 15;
